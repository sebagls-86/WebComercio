...
namespace WebComercio.Controllers
{
    public class ComprasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CompraId,idUsuario,Total")] Compra compra)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CompraId,idUsuario,Total")] Compra compra)
        {
